...
//                        var num = -((parseInt(mainpop) - 1) * (h - 20)); 
                    ...
                    var $start_o = $("#content input[mainpop=1]");
                	$($start_o).focus();
                }
            } 
        }
...
//                    		var num = -(mainpop * (h-15));
                    	...
                    	var count_end = $('#content input[mainpop]').length; 
                    	var $end_o = $("#content input[mainpop=" + parseInt(count_end) + "]");
                    	$($end_o).focus();
                    }
                } else {
                	$('.next:eq(0) a').html("最后一项");
