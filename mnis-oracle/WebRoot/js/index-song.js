...
//		$(".demos input").attr('placeholder',current)
		$(".demos input").attr('value',current)
//		$("#lurutime").attr('value',current)
	});
    ...
    $('#content input[mainpop]').focus(function () {
        ...
        if (mainpop) {
            ...
            $("#content").css("top", num);
            isMainLast = mainpop == 11 ? true : false;
            ...
            if (mainpop) {
                if (!isMainFirst) {
                    ...
                    if ($prev) {
                        ...
                        var num4 = -((parseInt(mainpop) - 1) * (h - 40)); 
                        $("#content").css({
	                        "position": "relative",
	                        "top": num
                        })
                        if(mainpop = 4){
                        	$("#content").css("top",num4);
                        }
                    }
                } else {
                	$("#content").css({
