...
<body>
	...
	<div id="content">
		...
		<ul class="channellist">
			<li>
<%-- 				<a href="bingrengeti_jibenxingxi?v_key1=${bingrgetixingxi.key1}&v_key2=${bingrgetixingxi.key2}"> --%>
			...
			<li>
<%-- 			<a href="bingrengeti_bingan_shouye?v_key1=${bingrgetixingxi.key1}&v_key2=${bingrgetixingxi.key2}"> --%>
			...
			<li>
<%-- 			<a href="bingrGeTi_YiZhuBen?v_key1=${bingrgetixingxi.key1}&v_key2=${bingrgetixingxi.key2}&v_yebh=0"> --%>
			...
			<li>
<%-- 			<a href="bingrGeTi_JianYan?v_key1=${bingrgetixingxi.key1}&v_key2=${bingrgetixingxi.key2}&v_yebh=0"> --%>
