            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
                ...
                <div class="panel-body" style="padding: 5px;">
                    <div class="row" style="padding-top: 2%;padding-bottom: 2%;">
                        <div class="col-xs-7">
                            <a href="#" style="text-decoration: none;color: #080808;">经阴道B超:经阴道(常规)</a>
                        </div>
                        <div class="col-xs-5">
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                ...
                <div class="panel-body" style="padding: 5px;">
                    <div class="row" style="padding-top: 2%;padding-bottom: 2%;">
                        <div class="col-xs-7">
                            <a href="#" style="text-decoration: none;color: #080808;">X光透视一:胸部(正位)</a>
                        </div>
                        <div class="col-xs-5">
                            <a href="#" style="text-decoration: none;color: #080808;">王菲&nbsp;2016/03/01</a>
                        </div>
                    ...
                    <div class="row" style="padding-top: 2%;padding-bottom: 2%;">
                        <div class="col-xs-7">
                            <a href="#" style="text-decoration: none;color: #080808;">X光透视二:胸部(正位)</a>
                        </div>
                        <div class="col-xs-5">
                            <a href="#" style="text-decoration: none;color: #080808;">王菲&nbsp;2016/03/01</a>
                        </div>
                    ...
                    <div class="row" style="padding-top: 2%;padding-bottom: 2%;">
                        <div class="col-xs-7">
                            <a href="#" style="text-decoration: none;color: #080808;">X光透视三:胸部(正位)</a>
                        </div>
                        <div class="col-xs-5">
                            <a href="#" style="text-decoration: none;color: #080808;">王菲&nbsp;2016/03/01</a>
                        </div>
                    ...
                    <div class="row" style="padding-top: 2%;padding-bottom: 2%;">
                        <div class="col-xs-7">
                            <a href="#" style="text-decoration: none;color: #080808;">X光透视四:胸部(正位)</a>
                        </div>
                        <div class="col-xs-5">
                            <a href="#" style="text-decoration: none;color: #080808;">王菲&nbsp;2016/03/01</a>
                        </div>
                    ...
                    <div class="row" style="padding-top: 2%;padding-bottom: 2%;">
                        <div class="col-xs-7">
                            <a href="#" style="text-decoration: none;color: #080808;">X光透视五:胸部(正位)</a>
                        </div>
                        <div class="col-xs-5">
                            <a href="#" style="text-decoration: none;color: #080808;">王菲&nbsp;2016/03/01</a>
                        </div>
