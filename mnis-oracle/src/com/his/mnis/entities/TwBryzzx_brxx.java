...
public class TwBryzzx_brxx implements java.io.Serializable {
	...
	/** default constructor */
	public TwBryzzx_brxx() {
	}

	/** minimal constructor */
	public TwBryzzx_brxx(Long key1, Integer key2, Short yebh, Long groupxh,
	...
	public TwBryzzx_brxx(String rowkey, Long key1, Integer key2, Short yebh,
			Timestamp rq, Long groupxh, String sjd, Timestamp sjdtime,
			String bq, String chw, String bah, String xm, String xb, String nl,
			...
			String crlflag, Double crl, String czfl, String syflag) {
		super();
		this.rowkey = rowkey;
		this.key1 = key1;
		this.key2 = key2;
