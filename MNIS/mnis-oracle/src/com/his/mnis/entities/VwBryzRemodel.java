...
public class VwBryzRemodel implements java.io.Serializable {
	...
	/** default constructor */
	public VwBryzRemodel() {
	}

	/** minimal constructor */
	public VwBryzRemodel(Long key1, Integer key2, Short yebh, Long groupxh, Long xsxh,
