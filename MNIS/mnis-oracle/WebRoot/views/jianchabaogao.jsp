	...
	<div class="container">
		<s:iterator value="#request.bingrgeti_huayan">
			<div class="row" style="padding-top: 2%;padding-bottom: 2%;">
				<div class="col-xs-7">
					<a href="#" style="text-decoration: none;color: #080808;"><span
						style="color: #ADD1F7">&gt;</span>&nbsp;${yzmc }</a>
				</div>
				<div class="col-xs-5">
					<a href="#" style="text-decoration: none;color: #080808;">${sqysxm }&nbsp;<s:date
		...
		<div class="row" style="padding-top: 2%;padding-bottom: 2%;">
			<div class="col-xs-7">
				<a href="#" style="text-decoration: none;color: #080808;"><span
					style="color: #ADD1F7">&gt;</span>&nbsp;尿常规检查(尿液检查)</a>
			</div>
			<div class="col-xs-5">
		...
		<div class="row" style="padding-top: 2%;padding-bottom: 2%;">
			<div class="col-xs-7">
				<a href="#" style="text-decoration: none;color: #080808;"><span
					style="color: #ADD1F7">&gt;</span>&nbsp;APTT、PT(专业检查)</a>
			</div>
			<div class="col-xs-5">
				<a href="#" style="text-decoration: none;color: #080808;">王菲&nbsp;2016/03/01</a>
			</div>
		...
		<div class="row" style="padding-top: 2%;padding-bottom: 2%;">
			<div class="col-xs-7">
				<a href="#" style="text-decoration: none;color: #080808;"><span
					style="color: #ADD1F7">&gt;</span>&nbsp;血常规(五分类)(全血)</a>
			</div>
			<div class="col-xs-5">
		...
		<div class="row" style="padding-top: 2%;padding-bottom: 2%;">
			<div class="col-xs-7">
				<a href="#" style="text-decoration: none;color: #080808;"><span
					style="color: #ADD1F7">&gt;</span>&nbsp;电解质(血清)</a>
			</div>
			<div class="col-xs-5">
				<a href="#" style="text-decoration: none;color: #080808;">王菲&nbsp;2016/03/03</a>
			</div>
