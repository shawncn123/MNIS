...
<body class="bg-info">
	<div class="container">
		...
		<div class="row" style="border-bottom:1px solid #269abc;">
					...
					<div class="panel panel-default" style="margin: 10px 0 10px 0;">
						<div class="table-responsive">
							<table class="table table-condensed">
								<tr>
									<td colspan="2" class="text-center">五床</td>
									<td><img src="images/icon-add.png"
										class="img-responsive center-block" alt="5床"
										style="width: 80%;"></td>
								</tr>
								<tr>
									...
									<td colspan="2" class="text-left">范冰冰</td>
								</tr>
								<tr>
									<td colspan="2" class="text-center">30岁</td>
								</tr>
								<tr>
									<td colspan="3" class="text-center">临床路径:<span
										style="color: #31b0d5">执行中</span></td>
								</tr>
								<tr>
									<td
			...
			<a href="views/yewumokuai.jsp">
				<div class="col-xs-4" style="padding: 0 5px 0 5px;">
					<div class="panel panel-default" style="margin: 10px 0 20px 0;">
						<div class="table-responsive">
							<table class="table table-condensed">
								<tr>
									<td colspan="2" class="text-center">五床</td>
